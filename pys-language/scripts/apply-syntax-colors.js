...
const ROLE_SETTING_META = {
  comments: {
    order: 20,
    markdownDescription:
      "Color for comments. Change to override built-in theme colors for all themes; use **Reset Setting** to restore per-theme extension defaults.",
  },
  numbers: {
    order: 21,
    markdownDescription:
      "Color for numbers, booleans, and escapes. Change to override built-in theme colors; **Reset Setting** restores extension defaults.",
  },
  strings: {
    order: 22,
    markdownDescription:
      "Color for string literals. Change to override built-in theme colors; **Reset Setting** restores extension defaults.",
  },
  functions: {
    order: 23,
    markdownDescription:
      "Color for functions and methods. Change to override built-in theme colors; **Reset Setting** restores extension defaults.",
  },
  types: {
    order: 24,
    markdownDescription:
      "Color for types (classes, primitives, structs, …). In Settings, click the color square next to the hex to open the picker. Or run **PYS: Customize Syntax Colors** for swatch + hex + **Use color** (live editor update). **Reset Setting** restores extension defaults.",
  },
  "language-constants": {
    order: 25,
    markdownDescription:
      "Color for `this` / `super` and named constants. Change to override built-in theme colors; **Reset Setting** restores extension defaults.",
  },
  keywords: {
    order: 26,
    markdownDescription:
      "Color for keywords, storage modifiers, and decorators. Change to override built-in theme colors; **Reset Setting** restores extension defaults.",
  },
};
